...
/* ------------------------------------------------------------------ */
/* Particles background (inlined — no separate file/import needed)     */
/* ------------------------------------------------------------------ */

const defaultParticleColors = ["#7c3aed", "#3b82f6", "#14b8a6"];
...
function Documents({ business, appUser }) {
  ...
  // Mount-in reveal animation (matches Quotes module's .quo-in pattern)
  ...
  return (
    <div className="doc-page">
      <div className="doc-bg" aria-hidden="true">
        <Particles
          particleColors={["#7c3aed", "#3b82f6", "#14b8a6"]}
          particleCount={200}
          particleSpread={10}
          speed={0.1}
          particleBaseSize={100}
      ...
      <div className="doc-body">
        <div className={`doc-header ${mounted ? "doc-in" : ""}`}>
          <div>
        ...
        <div
          className={`doc-dropzone ${dragActive ? "doc-dropzone--active" : ""} ${mounted ? "doc-in" : ""}`}
        ...
        <div className={`doc-toolbar ${mounted ? "doc-in" : ""}`}>
        ...
        {loading ? (
          ...
          <div className={`doc-empty ${mounted ? "doc-in" : ""}`}>
          ...
          <div className={`doc-table-wrap ${mounted ? "doc-in" : ""}`}>
